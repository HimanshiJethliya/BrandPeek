...
export default function BrandDetailScreen() {
  ...
  const loadBrand = async () => {
    console.log('Loading brand with ID:', brandId);
    setLoading(true);
    setError(null);
    const { data, error } = await fetchBrandById(brandId);
    
    console.log('Brand detail response:', { data, error });
  ...
  if (!brand) return <ErrorScreen message="Brand not found" onRetry={() => router.back()} />;
